...
from utils.constants import DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, COLORS, STATUS_MESSAGES
...
class VPNConnectGUI:
    ...
    def _setup_ui(self):
        ...
        # Título
        title = tk.Label(self.window, text="VPN Corporativa", font=("Arial", 16, "bold"))
        title.pack(pady=10)

        # (MVP) Campo 2FA eliminado: el flujo es solo Port Knocking + VPN
    ...
    def do_connection(self):
        """Proceso completo: Port Knocking + VPN (MVP sin 2FA)"""
        try:
